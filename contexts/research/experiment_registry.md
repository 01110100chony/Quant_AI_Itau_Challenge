...
| LAF_001 | Liquidity Absorption Fragility | v0.1-draft | DRAFT | NONE | CLOSED | documentação Stage A1 autorizada; execução ainda não autorizada | [`spec`](../../research/experiments/LAF_001/spec.md) |
